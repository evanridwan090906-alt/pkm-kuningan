  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Activity Feed */}
        <div className="bg-[#1d58d8] rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
          <div className="relative z-10 h-full flex flex-col">
            ...
            <div className="flex-1 space-y-6 overflow-y-auto max-h-[300px] pr-2 custom-scrollbar">
              ...
              {students.slice(0, 5).map((student, idx) => (
                ...
                >
                  <img 
                    src={student.profile_photo_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(student.name)}&background=fff&color=1d58d8`}
